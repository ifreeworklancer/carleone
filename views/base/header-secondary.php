...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-130187394-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-130187394-1');
    </script>
    ...
    fbq('init', '754891908190205');
    fbq('track', 'PageView');
    fbq('track', 'CompleteRegistration');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=754891908190205&ev=PageView&noscript=1"
    /></noscript>
